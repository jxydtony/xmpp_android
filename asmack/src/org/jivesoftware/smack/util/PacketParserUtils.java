        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                //自定义解析time
                	...
                	message.setTime(parseContent(parser));
                }
                //自定义解析fromname
                else if(elementName.equals("fromname")){
                	message.setFromname(parseContent(parser));
                }
                //自定义解析servertime
                else if(elementName.equals("servertime")){
                	message.setServertime(parseContent(parser));
                }
                //自定义解析received
                else if(elementName.equals("received")){
                	message.setReceipts(true);
                	message.setReceiptId(parser.getAttributeValue("", "id"));
                }
                //自定义解析request
                else if(elementName.equals("request")){
                	message.setIsrequestReceipts(true);  
                }
