...
public class Message extends Packet {
    ...
    private String time;  //自定义内容
    private String fromname; //自定义内容
    private String servertime; //自定义内容
    private boolean isReceipts; //自定义内容
    private boolean isrequestReceipts; //自定义内容
    private String receiptId; //自定义内容
	...
	public boolean isIsrequestReceipts() {
		return isrequestReceipts;
	}

	public void setIsrequestReceipts(boolean isrequestReceipts) {
		this.isrequestReceipts = isrequestReceipts;
	}
