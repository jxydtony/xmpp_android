...
import org.jivesoftware.smack.debugger.MyLog;
        ...
        readerListener = new ReaderListener() {
            public void read(String str) {
            	...
            	if(Connection.DEBUG_ENABLED){
                	MyLog.d("smack",  dateFormatter.format(new Date()) + " RCV  (" + connection.hashCode() +
                            "): " +
                            str);
        ...
        writerListener = new WriterListener() {
            public void write(String str) {
            	Log.d("SMACK",
                        ...
                        str);
            	 if(Connection.DEBUG_ENABLED){
                 	MyLog.d("smack",  dateFormatter.format(new Date()) + " SENT (" + connection.hashCode() +
                             "): " +
                             str);
            ...
            public void processPacket(Packet packet) {
                if (printInterpreted) {
                	Log.d("SMACK",
                            ...
                            packet.toXML());
                	 if(Connection.DEBUG_ENABLED){
                     	MyLog.d("smack",  dateFormatter.format(new Date()) + " RCV PKT (" +
                                 connection.hashCode() +
                                 "): " +
                                 packet.toXML());
                     }
        ...
        connListener = new ConnectionListener() {
            public void connectionClosed() {
                Log.d("SMACK",
                        ...
                        ")");
                if(Connection.DEBUG_ENABLED){
                	MyLog.d("smack",  dateFormatter.format(new Date()) + " Connection closed (" +
                            connection.hashCode() +
                            ")");
            ...
            public void connectionClosedOnError(Exception e) {
                Log.d("SMACK",
                        ...
                        ")");
                if(Connection.DEBUG_ENABLED){
                	MyLog.d("smack",  dateFormatter.format(new Date()) +
                            " Connection closed due to an exception (" +
                            connection.hashCode() +
                            ")");
            ...
            public void reconnectionSuccessful() {
                Log.d("SMACK",
                        ...
                        ")");
                if(Connection.DEBUG_ENABLED){
                	MyLog.d("smack",  dateFormatter.format(new Date()) + " Connection reconnected (" +
                            connection.hashCode() +
                            ")");
            ...
            public void reconnectingIn(int seconds) {
                ...
                if(Connection.DEBUG_ENABLED){
                	MyLog.d("smack",  dateFormatter.format(new Date()) + " Connection (" +
                            connection.hashCode() +
                            ") will reconnect in " + seconds);
